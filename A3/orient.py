...
# Supriya Ayalur Balasubramanian - KNN (sayalurb)
# Sumeet Mishra - Adaboost (sumish)
# Varun Miranda - Random Forest (varmiran)
...
def predictlabels(sorted_labels,testdata, k):
...
if argtype.lower()=="train":    
    ...
    if model.lower() == "nearest" or model == "best":
        ...
        accuracy=predictlabels(sorted_labels,testdata,k)
